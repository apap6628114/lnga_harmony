...
- **`oh26_web`（API 26 / HarmonyOS 7.0.0）** — 网页版 API 备份分支，**已暂停新功能开发**，仅维护关键错误修复。
- **`oh23`（API 23 / HarmonyOS 6.1.0）** — 旧版备份分支，**已暂停新功能开发**，仅维护关键错误修复。

> 需要基于网页版 API 的稳定版本时，请切换到 `oh26_web` 分支；需要基于 API 23 的稳定版本时，请切换到 `oh23` 分支获取源码，或使用对应的旧版 Releases。
